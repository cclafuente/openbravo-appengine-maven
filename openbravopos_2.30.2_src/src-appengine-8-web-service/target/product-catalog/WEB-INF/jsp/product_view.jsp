            ...
            <script type="text/javascript">
                $(document).ready(function () {
                    var data = [
                        ...
                        {label: "<fmt:message key='label.ProductPriceMargin'/>", data: ${actionBean.product.priceBuy - actionBean.product.priceSell}},
                        {label: "<fmt:message key='label.ProductPriceTax'/>", data: ${actionBean.product.priceSell - actionBean.product.taxPriceSell}}];
