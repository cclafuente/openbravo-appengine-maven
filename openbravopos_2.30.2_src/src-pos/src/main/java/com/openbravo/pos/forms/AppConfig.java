...
//        m_propsconfig.setProperty("db.password", "");
        ...
        //  m_propsconfig.setProperty("db.driverlib", new File(new File(dirname), "lib/hsqldb.jar").getAbsolutePath());
          ...
          m_propsconfig.setProperty("db.URL", "jdbc:mysql://173.194.233.193/openbravopos1");
          m_propsconfig.setProperty("db.user", "testuser");         
          m_propsconfig.setProperty("db.password", "testpass");
