...
//        jcboLAF.addItem(new UIManager.LookAndFeelInfo("Openbravo", "com.openbravo.pos.skin.OpenbravoLookAndFeel"));
        ...
        jcboMachineScale.addItem("gramasep15");
    ...
    public void loadProperties(AppConfig config) {
        ...
        if ("dialog1".equals(sparam) || "samsungesp".equals(sparam) || "gramasep15".equals(sparam)) {
    ...
    public void saveProperties(AppConfig config) {
        ...
        if ("dialog1".equals(sMachineScale) || "samsungesp".equals(sMachineScale) || "gramasep15".equals(sMachineScale)) {
    ...
    private void jcboMachineScaleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcboMachineScaleActionPerformed
        ...
        if ("dialog1".equals(jcboMachineScale.getSelectedItem()) || "samsungesp".equals(jcboMachineScale.getSelectedItem()) ||  "gramasep15".equals(jcboMachineScale.getSelectedItem())) {
