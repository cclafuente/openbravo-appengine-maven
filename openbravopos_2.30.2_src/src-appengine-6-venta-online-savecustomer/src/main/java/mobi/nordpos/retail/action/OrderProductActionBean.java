...
import com.openbravo.pos.ticket.CustomerInfoExt;
    ...
    public void tryOrderChange(ValidationErrors errors) {
        ...
        try {
            ...
            if (sharedTicket == null) {
                ...
                //revisamos integracion cliente
                //ticket.setM_Customer(new CustomerInfoExt(getContext().getCustomer().getId().toString()));
                //revisamos integracion cliente, pendiente de eliminar
