...
public class OrderPostActionBean extends OrderBaseActionBean {
	...
	private static Logger logger = LoggerFactory.getLogger(OrderPostActionBean.class);
...
//            out.println(result.getReasonResponseCode() + " : " + result.getResponseText());
        ...
        try {
        	logger.warn(" inicializando conexiones para el pago . 1");
            ...
            logger.warn(" addTaxLineList . 2 ");
            
            ticket = getPostedTicket(order, receipt);
            
            logger.warn(" getPostedTicket . 3 ");

            payment.setReceipt(receipt);
            
            logger.warn(" setReceipt . 4. payment details " + ReflectionToStringBuilder.toString(payment, ToStringStyle.MULTI_LINE_STYLE));
            ...
            logger.warn(" persistimos pago " + ReflectionToStringBuilder.toString(payment, ToStringStyle.MULTI_LINE_STYLE));
